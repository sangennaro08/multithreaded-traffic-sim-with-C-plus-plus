...
void TrafficAlgorithm::start_algorithm(std::unique_ptr<Incrocio>& Actual_Incrocio, std::unique_ptr<Incrocio>& Next_Incrocio, Auto* A)
{
    int tentativi = 0;
    A->choosed = false;
...
void TrafficAlgorithm::go_alone(std::unique_ptr<Incrocio>& Next_Incrocio, Auto* A, int tentativi)
{
...
void TrafficAlgorithm::search_exit(std::unique_ptr<Incrocio>& Actual_Incrocio, std::unique_ptr<Incrocio>& Next_Incrocio, Auto* A)
{
